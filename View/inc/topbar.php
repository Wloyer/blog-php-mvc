	...
	<nav class=" nav-custom">
		<div class="container">
			<div class="nav-wrapper ">
				...
				<a href="<?= ROOT_URL ?>index.php" class="brand-logo"><img src="static\img\logo\saccharoselogo1436.png" alt="logo"> </a>
				...
				<ul class="right hide-on-med-and-down ">
					...
					<li class="<?php echo ($_GET['a'] == "chapters") ? "active" : ""; ?>"><a href="<?= ROOT_URL ?>blog_chapters.html">Boutique</a></li>

					<?php if (empty($_SESSION['is_admin']) && empty($_SESSION['is_user'])) : ?>
						<li><a href="<?= ROOT_URL ?>blog_login.html" class="btn orange waves-effect waves-light">Connexion<i class="material-icons right">lock_open</i></a></li>
					<?php endif ?>
				...
				<ul class="side-nav" id="mobile-menu">
					...
					<li class="<?php echo ($_GET['a'] == "index") ? "active" : ""; ?>"><a href="<?= ROOT_URL ?>index.php">Accueil</a></li>
